...
const invalidCohortUpload = generateUpload(
  [],
  nurse,
  UploadType.Cohort,
...
// Add failed cohort upload (too many records without PDS matches)
const failedCohortUpload = generateUpload(
  [],
  nurse,
  UploadType.Cohort,
  UploadStatus.Failed
)
context.uploads[failedCohortUpload.id] = failedCohortUpload

// Add devoid cohort upload (no new patient records)
const devoidCohortUpload = generateUpload(undefined, nurse, UploadType.Cohort)
