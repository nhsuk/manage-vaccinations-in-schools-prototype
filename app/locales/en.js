...
export const en = {
  ...
  patientSession: {
    ...
    vaccination: {
      label: '{{programme.name}} vaccination'
    }
  },
  programme: {
    list: {
  ...
  texts: {
    consent: {
      invite: {
        ...
        text: 'Give or refuse consent for your child’s {{session.vaccination}} by going to [https://give-or-refuse-consent.nhs.uk/{{session.id}}](/consents/{{session.id}}). You need to do this by {{session.formatted.openAt}}.\n\nResponding will take less than 5 minutes.'
      },
      'invite-clinic': {
        label: 'Clinic booking',
      ...
      'invite-reminder': {
        ...
        text: 'We recently asked for your consent to vaccinate your child against {{session.immunisation}}.\n\nGo to [https://give-or-refuse-consent.nhs.uk/{{session.id}}](/consents/{{session.id}}) to submit a response. This will take less than 5 minutes.'
      },
      'consent-given': {
        label: 'Consent given',
