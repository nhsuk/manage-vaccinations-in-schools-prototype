...
export default {
  ...
  '43208811000001106': {
    ...
    delegationProtocols: [VaccinationProtocol.PGD, VaccinationProtocol.PSD],
    dose: 0.2,
    sideEffects: [
  ...
  '40085011000001101': {
    ...
    delegationProtocols: [VaccinationProtocol.National],
    dose: 0.5,
    sideEffects: [
  ...
  '33493111000001108': {
    ...
    method: VaccineMethod.Injection,
    delegationProtocols: [VaccinationProtocol.PSD],
    dose: 0.5,
    sideEffects: [
